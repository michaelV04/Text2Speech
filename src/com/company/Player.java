...
//
    ...
    public void showmap() {
        ...
        switch (location) {
            ...
            case "entrance1" -> panel.add(new JLabel(new ImageIcon("Figures/8.jpg")));
            case "road1" -> panel.add(new JLabel(new ImageIcon("Figures/9.jpg")));
            case "road2" -> panel.add(new JLabel(new ImageIcon("Figures/10.jpg")));
            case "road3" -> panel.add(new JLabel(new ImageIcon("Figures/11.jpg")));
            case "road4" -> panel.add(new JLabel(new ImageIcon("Figures/12.jpg")));
            case "road5" -> panel.add(new JLabel(new ImageIcon("Figures/13.jpg")));
            case "road6" -> panel.add(new JLabel(new ImageIcon("Figures/14.jpg")));
            case "house1" -> panel.add(new JLabel(new ImageIcon("Figures/15.jpg")));
            case "down_house1" -> panel.add(new JLabel(new ImageIcon("Figures/15.jpg")));
            case "road7" -> panel.add(new JLabel(new ImageIcon("Figures/16.jpg")));
            case "house2" -> panel.add(new JLabel(new ImageIcon("Figures/17.jpg")));
            case "up_house2" -> panel.add(new JLabel(new ImageIcon("Figures/17.jpg")));
            case "road8" -> panel.add(new JLabel(new ImageIcon("Figures/18.jpg")));
            case "road9" -> panel.add(new JLabel(new ImageIcon("Figures/19.jpg")));
            case "road10" -> panel.add(new JLabel(new ImageIcon("Figures/20.jpg")));
            case "road11" -> panel.add(new JLabel(new ImageIcon("Figures/21.jpg")));
            case "house3" -> panel.add(new JLabel(new ImageIcon("Figures/22.jpg")));
            case "up_house3" -> panel.add(new JLabel(new ImageIcon("Figures/22.jpg")));
            case "road12" -> panel.add(new JLabel(new ImageIcon("Figures/23.jpg")));
            case "road13" -> panel.add(new JLabel(new ImageIcon("Figures/24.jpg")));
            case "temple1" -> panel.add(new JLabel(new ImageIcon("Figures/25.jpg")));
            case "up_temple1" -> panel.add(new JLabel(new ImageIcon("Figures/25.jpg")));
            case "road14" -> panel.add(new JLabel(new ImageIcon("Figures/26.jpg")));
            case "house4" -> panel.add(new JLabel(new ImageIcon("Figures/27.jpg")));
            case "road15" -> panel.add(new JLabel(new ImageIcon("Figures/28.jpg")));
            case "road16" -> panel.add(new JLabel(new ImageIcon("Figures/29.jpg")));
            case "temple2" -> panel.add(new JLabel(new ImageIcon("Figures/30.jpg")));
            case "up_temple2" -> panel.add(new JLabel(new ImageIcon("Figures/30.jpg")));
            case "road17" -> panel.add(new JLabel(new ImageIcon("Figures/31.jpg")));
            case "road18" -> panel.add(new JLabel(new ImageIcon("Figures/32.jpg")));
            case "road19" -> panel.add(new JLabel(new ImageIcon("Figures/33.jpg")));
            case "road20" -> panel.add(new JLabel(new ImageIcon("Figures/34.jpg")));
            case "road21" -> panel.add(new JLabel(new ImageIcon("Figures/35.jpg")));
            case "road22" -> panel.add(new JLabel(new ImageIcon("Figures/36.jpg")));
            case "road23" -> panel.add(new JLabel(new ImageIcon("Figures/37.jpg")));
            case "road24" -> panel.add(new JLabel(new ImageIcon("Figures/38.jpg")));
            case "plateau" -> panel.add(new JLabel(new ImageIcon("Figures/39.jpg")));
            case "up_plateau" -> panel.add(new JLabel(new ImageIcon("Figures/39.jpg")));
            case "road25" -> panel.add(new JLabel(new ImageIcon("Figures/40.jpg")));
            case "road26" -> panel.add(new JLabel(new ImageIcon("Figures/41.jpg")));
            case "road27" -> panel.add(new JLabel(new ImageIcon("Figures/42.jpg")));
            case "outpost1" -> panel.add(new JLabel(new ImageIcon("Figures/43.jpg")));
            case "down_outpost1" -> panel.add(new JLabel(new ImageIcon("Figures/43.jpg")));
            default -> {
            }
        }
        frame.add(panel);
